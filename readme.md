...
백준 알고리즘에서 수학 부분을 듣고 문제플 풀었다.  
강의에서 최대공약수는 "유클리드 호제법" 를 사용하여 문제를 해결했다
...
유니코드를 사용해서 문제를 해결했다 :)  
끝나고 다른사람 소스를 보니 대문자, 소문자 검사하는 파이썬 함수가 있었다....
...
[소스풀이](/baekjoon/10799.py)

문제를 이해하는데 오래걸려서 1시간동안 풀었다.  
하지만 첫 제출로 단번에 통과했다 :)  
다 풀고 본 다른 사람 풀이는 놀라웠다
...
[소스풀이](/baekjoon/1874.py)

스택 자체가 쉽다고 생각했지만 이문제를 풀면서 나름 어렵다고 생각했다
